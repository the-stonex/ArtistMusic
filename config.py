...
class Config:
    def __init__(self):
        ...
        self.DURATION_LIMIT: int = (
            int(getenv("DURATION_LIMIT", "9999")) * 60
        )
        ...
        self.VIDEO_PLAY: bool = self._str_to_bool(
            getenv("VIDEO_PLAY", "True")
        )
        ...
        self.SHRUTI_API_URL: str = getenv(
            "SHRUTI_API_URL",
        ...
        self.ENABLE_API: bool = self._str_to_bool(
            getenv("ENABLE_API", "True")
        )

        self.ENABLE_COOKIES_FALLBACK: bool = (
            self._str_to_bool(
                getenv(
                    "ENABLE_COOKIES_FALLBACK",
                    "True"
                )
            )
        )
        ...
        self.API_TIMEOUT: int = int(
            getenv("API_TIMEOUT", "300")
        )

        self.API_STREAM_TIMEOUT: int = int(
            getenv("API_STREAM_TIMEOUT", "600")
        )
